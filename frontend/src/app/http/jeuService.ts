...
export class JeuService {
  ...
  httpEre(nomCivilisation:string, nomEnvironnement: string): Observable<any> {
    return this.fetchData(this.apiUrl + "ereActuelle?nomJoueur="+nomCivilisation+"-"+nomEnvironnement);
  }
